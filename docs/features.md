...
*   **Customizable Output**: Choose which columns to display and output results in different formats (table, vertical, CSV, JSON, newline-delimited JSON via `ndjson`, or an indented `tree` process forest).
